          ...
          <div className="order-1 lg:order-2">
            <div className="relative">
              ...
              <div className="bg-white rounded-xl shadow-xl overflow-hidden">
                ...
                <div className="p-6 bg-white">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-primary-600 font-medium">See how it works</span>
              ...
              <div className="absolute -bottom-6 -right-6 bg-green-100 rounded-lg p-4 shadow-lg max-w-xs">
                ...
                <p className="text-gray-700 text-sm">Teachers using ONE save an average of 6 hours per week on lesson planning.</p>
              </div>
            </div>
          </div>
        </div>
